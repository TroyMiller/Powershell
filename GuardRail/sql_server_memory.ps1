...
ForEach ($instance in $instances) {
       $serverinfo = New-Object ('Microsoft.SqlServer.Management.Smo.Server') $instance.fullname
       $result = new-object PSObject
       $result | Add-Member -MemberType NoteProperty -Name "Instance" -value $serverinfo.servicename
       $result | Add-Member -MemberType NoteProperty -Name "MaxServerMemory" -value $serverinfo.configuration.MaxServerMemory.ConfigValue 
       $result | Add-Member -MemberType NoteProperty -Name "MinServerMemory" -value $serverinfo.configuration.MinServerMemory.ConfigValue
       $result | Add-Member -MemberType NoteProperty -Name "CrossDBOwnershipChaining" -value $serverinfo.configuration.CrossDBOwnershipChaining.ConfigValue
       $result | Add-Member -MemberType NoteProperty -Name "xp_cmdshell" -value $serverinfo.configuration.XPCMdShellEnabled.ConfigValue
       $result | Add-Member -MemberType NoteProperty -Name "FilestreamAccessLevel" -value $serverinfo.configuration.FileStreamAccessLevel.ConfigValue
       $result | Add-Member -MemberType NoteProperty -Name "DefaultBackupCompression" -value $serverinfo.configuration.DefaultBackupCompression.ConfigValue
       $result
      } 
