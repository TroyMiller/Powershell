...
ForEach ($instance in $instances) {
       ...
       $serverinfo | select ClusterName, ClusterQuorumState, ClusterQuorumType, Collation, CollationID, DefaultFile, DefaultLog, Edition, ErrorLogPath, FilestreamLevel, InstallDataDirectory, InstallSharedDirectory, InstanceName,LoginMode,PhysicalMemory,Processors,ServerType,ServiceAccount,ServiceInstanceId,ServiceName,ServiceStartMode,SqlCharSet,SqlCharSetName,SqlDomainGroup,SqlSortOrder,SqlSortOrderName,Status,VersionString,Name
      } 
